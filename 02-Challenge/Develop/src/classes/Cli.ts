  ...
  createVehicle(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.vehicleType === 'Motorcycle') {
  ...
  createMotorbike(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        const backWheel = new Wheel(answers.frontWheelDiameter, answers.frontWheelBrand)
        const wheels = [frontWheel,backWheel]
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              ...
              if (this.vehicles[i] instanceof Truck) {
                ...
                return;
              } else console.log('only trucks can tow vehicles');
            }
          }
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              ...
              if (this.vehicles[i] instanceof Motorbike) {
                ...
                return;
              } else console.log('only motorbikes can wheelie') 
            }
          }
        }
